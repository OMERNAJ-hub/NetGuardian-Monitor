...
requests for NetGuardian. I never thought the GitHub community would be so nice!
...
## Can I Create a Pull Request for NetGuardian?
...
- <details><summary><b>Security Fixes</b> (click to expand)</summary>
  ...
  [advisory]: https://github.com/louislam/netguardian/security/advisories/new
  [issue]: https://github.com/louislam/netguardian/issues/new?template=security_issue.yml
...
- <details><summary><b>Translations / Internationalisation (i18n)</b> (click to expand)</summary>
  ...
  We use Weblate to localise this project into many languages. If you want to help translate NetGuardian into your language, please see [these instructions on how to translate using Weblate](https://github.com/louislam/netguardian/blob/master/src/lang/README.md).
  ...
  - **Adding a new language** requires creating a new file. See [these instructions](https://github.com/louislam/netguardian/blob/master/src/lang/README.md).
...
- <details><summary><b>New Monitoring Types</b> (click to expand)</summary>
  ...
  - `server/netguardian-server.js` is where the monitoring backend needs to be
...
- <details><summary><b>As a First-Time Contributor</b> (click to expand)</summary>
  ...
  1. **Fork** the [netguardian repository](https://github.com/louislam/netguardian/) and **clone** it to your local machine.
  2. **Create a new branch** for your changes (e.g., `signal-notification-provider`).
  3. **Make your changes** and **commit** them with a clear message.
  4. **Push** your changes to your forked repository.
  5. **Open a pull request** to the `master` branch of the NetGuardian repository.
...
- Make sure the **UI/UX is close to NetGuardian**.
...
We will assign your pull request to a [milestone](https://github.com/louislam/netguardian/milestones), if we plan to review and merge it.
...
you can finally start the app. The goal is to make the NetGuardian installation
...
- `netguardian-server.js` (UptimeKumaServer class, main logic should be here,
...
NetGuardian Frontend is a single page application (SPA). Most paths are handled
by Vue Router.
...
See: <https://github.com/louislam/netguardian/tree/master/db/knex_migrations>
...
<https://github.com/louislam/netguardian-wiki>
...
- <details><summary><b>Release</b> (click to expand)</summary>
  ...
  - [ ] Check all tags is fine on
        <https://hub.docker.com/r/louislam/netguardian/tags>
...
- <details><summary><b>Release Wiki</b> (click to expand)</summary>
  ...
  **Setup Repo**
  ...
  ```bash
  git clone https://github.com/louislam/netguardian-wiki.git
  cd netguardian-wiki
  git remote add production https://github.com/louislam/netguardian.wiki.git
  ```
