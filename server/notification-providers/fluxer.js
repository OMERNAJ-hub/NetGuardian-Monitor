...
class Fluxer extends NotificationProvider {
    ...
    async send(notification, msg, monitorJSON = null, heartbeatJSON = null) {
        ...
        try {
            ...
            const fluxerDisplayName = notification.fluxerUsername || "NetGuardian";
            ...
            if (heartbeatJSON == null) {
                ...
                if (!webhookHasAvatar) {
                    fluxertestdata.avatar_url = "https://github.com/louislam/netguardian/raw/master/public/icon.png";
                }
            ...
            if (heartbeatJSON["status"] === DOWN) {
                ...
                if (!webhookHasAvatar) {
                    fluxerdowndata.avatar_url = "https://github.com/louislam/netguardian/raw/master/public/icon.png";
                }
                ...
                if (!webhookHasAvatar) {
                    fluxerupdata.avatar_url = "https://github.com/louislam/netguardian/raw/master/public/icon.png";
                }
                if (notification.fluxerPrefixMessage) {
