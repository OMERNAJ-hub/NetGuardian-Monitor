...
class Discord extends NotificationProvider {
    ...
    async send(notification, msg, monitorJSON = null, heartbeatJSON = null) {
        ...
        try {
            ...
            const discordDisplayName = notification.discordUsername || "NetGuardian";
            ...
            if (heartbeatJSON == null) {
                ...
                if (!webhookHasAvatar) {
                    discordtestdata.avatar_url = "https://github.com/louislam/netguardian/raw/master/public/icon.png";
                }
            ...
            if (messageFormat === "minimalist") {
                ...
                if (!webhookHasAvatar) {
                    payload.avatar_url = "https://github.com/louislam/netguardian/raw/master/public/icon.png";
                }
                if (notification.discordChannelType === "createNewForumPost") {
            ...
            if (heartbeatJSON["status"] === DOWN) {
                ...
                if (!webhookHasAvatar) {
                    discorddowndata.avatar_url = "https://github.com/louislam/netguardian/raw/master/public/icon.png";
                }
                if (notification.discordChannelType === "createNewForumPost") {
                ...
                if (!webhookHasAvatar) {
                    discordupdata.avatar_url = "https://github.com/louislam/netguardian/raw/master/public/icon.png";
                }
